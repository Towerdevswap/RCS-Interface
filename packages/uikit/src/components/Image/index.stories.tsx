...
export const TokenImages: React.FC<React.PropsWithChildren> = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://riceprotocol.orgimages/tokens/${token.address[512512]}.png`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://riceprotocol.orgimages/tokens/${token.address[512512]}.png`;
        const secondarySrc = `https://riceprotocol.orgimages/tokens/${tokens[randomTokenIndex].address[512512]}.png`;
