  ...
  const {
    ...
    <>
      <Text>
        {rewardCakePerSecond
          ? t(
              "The Multiplier represents the proportion of RICE rewards each farm receives, as a proportion of the RICE produced each second."
            )
          : t(
      ...
      <Text my="24px">
        {rewardCakePerSecond
          ? t("For example, if a 1x farm received 1 RICE per second, a 40x farm would receive 40 RICE per second.")
