...
export const INFO_CLIENT = 'https://graph-core.icecreamswap.com/subgraphs/name/simone1999/icecreamswap-core'

export const INFO_CLIENT_ETH = 'https://api.thegraph.com/subgraphs/name/pancakeswap/exhange-eth'
export const BLOCKS_CLIENT = 'https://graph-core.icecreamswap.com/subgraphs/name/icecreamswap/blocks-core'
