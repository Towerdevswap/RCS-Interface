...
export const DEFAULT_META: PageMeta = {
  title: 'RiceSwap',
  description:
    'The most popular AMM on Bitgert & Core chain by user count! Earn TW through yield farming or win it in the Lottery, then stake it in Rice Pools to earn more tokens!',
  image: 'https://core.riceprotocol.org/images/banner.png',
}
